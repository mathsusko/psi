...
//   if (isError) return <div>Erro ao carregar filiais</div>
...
//                       if (confirmar) {
//                         try {
//                           await deletarFilial(filial._id)
...
import { toast } from 'sonner'
import { useCliente } from '@/hooks/useCliente' // Importando o hook para buscar o cliente
...
export default function FiliaisDoCliente() {
  ...
  // Buscar dados do cliente (nome da empresa)
  const {
    data: clienteData,
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        {/* Aqui, exibe o nome da empresa, que vem do cliente */}
      ...
      <ModalNovaFilial
        ...
        onOpenChange={(v) => {
          setOpenModal(v)
          if (!v) refetch() // Atualiza lista após fechar modal
        }}
        clientePaiId={clientePaiId!}
      />
    </div>
