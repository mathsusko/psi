              ...
              <View style={styles}>
                ...
                <View style={styles.prestadorInfoOne}>
                  <Text style={styles.prestadorInfoText}>
                    <Text style={styles.label}>CNPJ:</Text> {orcamento.prestadorId?.cnpj}
                  </Text>
                  <Text style={styles.prestadorInfoText}>
                    <Text style={styles.label}>I.E:</Text> {orcamento.prestadorId?.ie}
                  </Text>
                </View>
              </View>
              <View style={styles.prestadorInfoTwo}>
                <Text style={styles.prestadorInfoText}>
                  <Text style={styles.label}>E-mail:</Text> {orcamento.prestadorId?.email}
                </Text>
                <Text style={styles.prestadorInfoText}>
                  <Text style={styles.label}>Telefone:</Text>{' '}
                  {orcamento.prestadorId?.telefone}
                </Text>
                <Text style={styles.prestadorInfoText}>
